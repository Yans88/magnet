...
export const setoranSlice = createSlice({
    ...
    extraReducers: {
        ...
        [actionSetor.fulfilled]: (state, { payload }) => {
            ...
            state.contentMsg = "<div style='font-size:20px; text-align:center; line-height:23px;'><strong>Terima kasih</strong><br/> konfimarsi setor anda sudah terkirim, tim kami akan segera melakukan pengecekan</div>";
