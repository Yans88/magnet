...
const Login = () => {
  ...
  const { isFetching, isSuccess, errorMessage, myStatus } =
  ...
  const contentDelete = (
    <div
      dangerouslySetInnerHTML={{
        __html:
          '<div id="caption" style=padding-bottom:20px;">Akun Anda sudah tidak dapat digunakan Untuk bantuan lebih lanjut Anda bisa menghubungi kami di <a href=" https://www.magnetfx.co.id/contact">sini</a></div>',
      }}
    />
  );
